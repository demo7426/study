...
proc create_root_design { parentCell } {
  ...
  set IIC_rw_eeprom [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 IIC_rw_eeprom ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_IIC_0 [get_bd_intf_ports IIC_rw_eeprom] [get_bd_intf_pins processing_system7_0/IIC_0]
