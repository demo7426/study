...
HD_PWD='F:/ZYNQ/Embedded_System/navigator_v2/7020/ps_pl_bram/ps_pl_bram.runs/system_pl_bram_rd_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_pl_bram_rd_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_pl_bram_rd_0_1.tcl
