...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../axi_mio_interrupt.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../axi_mio_interrupt.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"../../../../axi_mio_interrupt.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../axi_mio_interrupt.gen/sources_1/bd/system/ipshared/34f8/hdl" \
