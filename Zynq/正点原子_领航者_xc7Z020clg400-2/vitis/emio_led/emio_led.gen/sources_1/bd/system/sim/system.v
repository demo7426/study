...
module system
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO_emio_led " *) input [0:0]GPIO_emio_led_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO_emio_led " *) output [0:0]GPIO_emio_led_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO_emio_led " *) output [0:0]GPIO_emio_led_tri_t;
  ...
  assign GPIO_emio_led_tri_o[0] = processing_system7_0_GPIO_0_TRI_O;
  assign GPIO_emio_led_tri_t[0] = processing_system7_0_GPIO_0_TRI_T;
  assign processing_system7_0_GPIO_0_TRI_I = GPIO_emio_led_tri_i[0];
