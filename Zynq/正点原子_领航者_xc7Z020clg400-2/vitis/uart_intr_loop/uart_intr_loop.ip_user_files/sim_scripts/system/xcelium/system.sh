...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../uart_intr_loop.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../uart_intr_loop.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"../../../../uart_intr_loop.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../uart_intr_loop.gen/sources_1/bd/system/ipshared/34f8/hdl" \
