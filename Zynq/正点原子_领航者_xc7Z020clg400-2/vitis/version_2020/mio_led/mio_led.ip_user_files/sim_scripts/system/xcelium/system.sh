...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../mio_led.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../mio_led.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"../../../../mio_led.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../mio_led.gen/sources_1/bd/system/ipshared/34f8/hdl" \
