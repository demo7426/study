...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../micro_sd_rw.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../micro_sd_rw.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"../../../../micro_sd_rw.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../micro_sd_rw.gen/sources_1/bd/system/ipshared/34f8/hdl" \
