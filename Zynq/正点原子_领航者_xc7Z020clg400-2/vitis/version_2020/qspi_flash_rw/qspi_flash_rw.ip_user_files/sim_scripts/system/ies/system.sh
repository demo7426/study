...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../qspi_flash_rw.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../qspi_flash_rw.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"../../../../qspi_flash_rw.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../qspi_flash_rw.gen/sources_1/bd/system/ipshared/34f8/hdl" \
