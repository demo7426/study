...
proc create_root_design { parentCell } {
  ...
  set gpio_axi_key [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 gpio_axi_key ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports gpio_axi_key] [get_bd_intf_pins axi_gpio_0/GPIO]
