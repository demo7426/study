...
HD_PWD='D:/Zynq/vitis/version_2020/dual_core_amp_system/vivado/dual_core_amp_system.runs/system_breath_led_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_breath_led_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_breath_led_ip_0_0.tcl
