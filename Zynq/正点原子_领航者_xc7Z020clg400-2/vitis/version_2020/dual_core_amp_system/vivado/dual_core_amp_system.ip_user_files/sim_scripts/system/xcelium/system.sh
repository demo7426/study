...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../dual_core_amp_system.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../dual_core_amp_system.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"../../../../dual_core_amp_system.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../dual_core_amp_system.gen/sources_1/bd/system/ipshared/34f8/hdl" \
