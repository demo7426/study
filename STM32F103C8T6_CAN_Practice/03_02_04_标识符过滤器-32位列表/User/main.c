...
int main(void)
{
	...
	CanTxMsg tCanTxMsg[] = {
		...
		{0x123, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 		4, 	{ 0x00, 0x01, 0x02, 0x03}},
		{0x234, 0x12345678, CAN_Id_Standard, CAN_RTR_Data, 		4, 	{ 0x00, 0x01, 0x02, 0x03}},
		{0x345, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 		4, 	{ 0x00, 0x01, 0x02, 0x03}},
		{0x456, 0x14785236, CAN_Id_Standard, CAN_RTR_Data, 		4, 	{ 0x00, 0x01, 0x02, 0x03}},
