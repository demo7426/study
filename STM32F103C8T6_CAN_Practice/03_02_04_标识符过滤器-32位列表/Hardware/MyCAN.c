...
void MyCAN_Init(void)
{
	...
	uint32_t unID1 = 0x123<<21;
	uint32_t unID2 = (0x12345678u<<3)|0x4;
	...
	tCAN_FilterInitTypeDef.CAN_FilterIdHigh = unID1>>16;
	tCAN_FilterInitTypeDef.CAN_FilterIdLow = unID1;
	
	tCAN_FilterInitTypeDef.CAN_FilterMaskIdHigh = unID2>>16;	
	tCAN_FilterInitTypeDef.CAN_FilterMaskIdLow = unID2;
