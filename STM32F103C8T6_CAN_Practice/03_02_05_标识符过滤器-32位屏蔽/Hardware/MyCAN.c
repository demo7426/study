...
void MyCAN_Init(void)
{
	...
	uint32_t unID = (0x12345600u<<0x3)|0x4;
	uint32_t unMask = (0x1fffff00u<<3)|0x4|0x2;
	...
	tCAN_FilterInitTypeDef.CAN_FilterIdHigh = unID>>16;
	tCAN_FilterInitTypeDef.CAN_FilterIdLow = unID;
	
	tCAN_FilterInitTypeDef.CAN_FilterMaskIdHigh = unMask>>16;	
	tCAN_FilterInitTypeDef.CAN_FilterMaskIdLow = unMask;
