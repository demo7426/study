...
void MyCAN_Init(void)
{
	...
	tCAN_FilterInitTypeDef.CAN_FilterIdHigh = 0x200<<5;
	tCAN_FilterInitTypeDef.CAN_FilterMaskIdHigh = (0x700<<5)|0x10|0x8;	
	
	tCAN_FilterInitTypeDef.CAN_FilterIdLow = 0x320<<5;
	tCAN_FilterInitTypeDef.CAN_FilterMaskIdLow = (0x7F0<<5)|0x10|0x8;
