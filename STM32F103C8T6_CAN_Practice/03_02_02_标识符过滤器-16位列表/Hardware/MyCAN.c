...
void MyCAN_Init(void)
{
	...
	tCAN_FilterInitTypeDef.CAN_FilterIdHigh = 0x234<<5;
	tCAN_FilterInitTypeDef.CAN_FilterIdLow = 0x0345<<5;
	tCAN_FilterInitTypeDef.CAN_FilterMaskIdHigh = (0x567<<5)|0x10;	// |0x10--代表遥控帧
	tCAN_FilterInitTypeDef.CAN_FilterMaskIdLow = 0x000<<5;
	tCAN_FilterInitTypeDef.CAN_FilterScale = CAN_FilterScale_16bit;
	tCAN_FilterInitTypeDef.CAN_FilterMode = CAN_FilterMode_IdList;
