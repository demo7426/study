...
CMsg_Node::CMsg_Node(std::shared_ptr<CSession> _pSession, char* _pMsg, int _MsgLen)
{
...
CRecvMsg_Node::CRecvMsg_Node(std::shared_ptr<CSession> _pSession, unsigned short _TLV_Type, char* _pMsg, int _MsgLen) 
	: CMsg_Node(_pSession, _pMsg, _MsgLen)
{
