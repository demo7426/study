...
bool CXSDL::Init(int _Width, int _Height, Format _Fmt, void* _pWinID)
{
    ...
    case CXVideo_View::Format::RGBA:
        unFormat = SDL_PIXELFORMAT_RGBA8888;
        break;
    case CXVideo_View::Format::ARGB:
        unFormat = SDL_PIXELFORMAT_ABGR8888;
        break;
    case CXVideo_View::Format::YUV420P:
        unFormat = SDL_PIXELFORMAT_IYUV;
        break;
    case CXVideo_View::Format::NV12:
        unFormat = SDL_PIXELFORMAT_NV12;
        break;
    default:
        break;
    }
    ...
    //生成材质
    m_ptSDL_Texture = SDL_CreateTexture(m_ptSDL_Renderer, unFormat, SDL_TEXTUREACCESS_STREAMING, _Width, _Height);
    if (!m_ptSDL_Texture)
    {
        cout << SDL_GetError() << endl;
        return false;
