...
public:
	...
	/// <returns></returns>
	int AddStream(AVCodecContext* codec);
...
private:
	...
	std::vector<AVStream*> m_vec_ptAVStream;

	std::vector<AVRational> m_vec_tAVRational;

	std::string m_strDesUrl = "";			//目的url
};
