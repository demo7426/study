...
描  述: IO控制，使用直接的方式
备  注:	是否为直接的方式，有 IO Method 操作码决定，而非创建设备文件时的 Flags 决定
修改记录:
...
NTSTATUS Dispatch_BufferIOControl(_In_ struct _DEVICE_OBJECT* DeviceObject, _Inout_ struct _IRP* Irp)
{
	...
	__try
	{
		/////////////////////////////////////////获取以下相关信息必须放置在 __try内部，否则会造成win7 32系统阻塞/////////////////////////////////////////
		PCHAR pchOutBuf = MmGetSystemAddressForMdlSafe(Irp->MdlAddress, NormalPagePriority);//输出buf
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
